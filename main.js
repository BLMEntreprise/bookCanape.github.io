...
const canapes = [
  {
    ...
    "poids": ["55.5"],
    "options": [{"nom":"Extensible","image":"YY-01-O.jpg"}]
  },
  {
    "ref": "YY-02",
    "image": "YY-02.jpg",
    ...
    "poids": ["55.5"],
    "options": [{"nom":"Extensible","image":"YY-02-O.jpg"}]
  },
  {
    "ref": "YY-03",
    "image": "YY-03.jpg",
...
function generateCatalogue(canapes) {
  ...
  canapes.forEach(canape => {
    ...
    tailles.innerHTML = `<strong>Tailles:</strong> ${canape.tailles.join(' / ')}`;
    card.appendChild(tailles);

    // Cartons
    const cartons = document.createElement('p');
    cartons.innerHTML = `<strong>Cartons:</strong> ${canape.cartons.join(' / ')}`;
    card.appendChild(cartons);

    // Poids
    const poids = document.createElement('p');
    poids.innerHTML = `<strong>Poids:</strong> ${canape.poids.join(' / ')}`;
